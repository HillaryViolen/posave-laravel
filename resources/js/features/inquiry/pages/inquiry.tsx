            ...
            <div className="flex flex-col gap-8 py-8">
                ...
                <div className="flex flex-col overflow-hidden rounded-3xl bg-blue-50/50 md:flex-row">
                    ...
                    <div className="md:w-1/2">
                        <img src="/images/customer-service.jpg" alt="Customer Service" className="h-full min-h-[300px] w-full object-cover" />
                    </div>
                    {/* Teks Hero */}
                    <div className="flex flex-col justify-center p-8 md:w-1/2 md:p-12 lg:p-16">
                        <h1 className="text-4xl font-bold text-slate-800">
                            Butuh Bantuan? <br />
                            <span className="text-[#003399]">Kami Ada Disini</span>
                        </h1>
                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            <Button className="rounded-full bg-[#003399] px-8 hover:bg-[#002266]">
                                <PhoneCall className="mr-2 h-4 w-4" /> Hubungi Kami
                            </Button>
                            <Button variant="outline" className="rounded-full border-[#003399] px-8 text-[#003399] hover:bg-blue-50">
                ...
                <div className="flex flex-col items-center justify-between rounded-2xl border border-neutral-100 bg-white p-6 shadow-sm md:flex-row md:px-12">
                    <div className="flex items-center gap-6">
                        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-blue-50 text-[#003399]">
                    ...
                    <Button className="mt-6 w-full rounded-full bg-[#003399] px-8 hover:bg-[#002266] md:mt-0 md:w-auto">
                ...
                <div className="mt-4 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="mt-2 h-1 w-12 bg-[#003399]"></div> {/* Garis biru kecil */}
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex items-start gap-4">
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-blue-50 text-[#003399]">
                ...
                <div className="mt-8 flex flex-col items-center justify-between rounded-2xl bg-blue-50/50 p-8 md:flex-row md:px-12">
                    <div className="flex items-center gap-6">
                        <Headphones className="h-10 w-10 text-[#003399]" />
                        <div>
                    ...
                    <Button className="mt-6 h-12 w-full rounded-md bg-[#003399] px-8 hover:bg-[#002266] md:mt-0 md:w-auto">
