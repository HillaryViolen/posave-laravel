            ...
            <div className="w-full max-w-md rounded-2xl bg-[var(--neutral-white)] p-6 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="mt-2 flex justify-end gap-2">
                        <Button aria-label="Batal ubah kategori" type="button" variant="outline" onClick={handleClose}>
                            Batal
                        </Button>
                        <Button aria-label="Simpan perubahan kategori" type="submit" disabled={processing}>
